...
def main():
    ...
    # List of attachments
    filevivek = '/mnt/motionvideos/' + datetime.datetime.now().strftime('%Y%m%d%H%M.jpg')
    filevivek = '/mnt/motionvideos/' + ((datetime.datetime.now() - datetime.timedelta(minutes = 1)).strftime('%Y%m%d%H%M.jpg'))
    attachments = [filevivek, filevivek2]
    deletepath = 'sudo rm -r ' + filevivek
    deletepath2 = 'sudo rm -r ' + filevivek2
...
def main():
    ...
    # List of attachments
    #filevivek = '/mnt/motionvideos/' + datetime.datetime.now().strftime('%Y%m%d-timelapse.avi')
    filevivek2 = '/mnt/motionvideos/' + ((datetime.datetime.now() - datetime.timedelta(days = 1)).strftime('%Y%m%d-timelapse.avi'))
    #filevivek3 = '/mnt/motionvideos/201703030015.avi'
    attachments = [filevivek2]
...
def main():
    ...
    # List of attachments
    filevivek = '/mnt/motionvideos/' + datetime.datetime.now().strftime('%Y%m%d%H%M.avi')
    filevivek2 = '/mnt/motionvideos/' + ((datetime.datetime.now() - datetime.timedelta(minutes = 1)).strftime('%Y%m%d%H%M.avi'))
    filevivek3 = '/mnt/motionvideos/' + ((datetime.datetime.now() - datetime.timedelta(minutes = 2)).strftime('%Y%m%d%H%M.avi'))
    attachments = [filevivek, filevivek2, filevivek3]
    deletepath = 'sudo rm -r ' + filevivek
    deletepath2 = 'sudo rm -r ' + filevivek2
    deletepath3 = 'sudo rm -r ' + filevivek3
